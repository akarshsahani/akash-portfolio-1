...
const infoData = [
    ...
    },
    {
        ...
        text: 'courseemail@gmail.com',
    },
    {
        icon: <Calendar size={20} />,
        text: 'Born on 23 Jul, 2003',
    },
    {
        icon: <GraduationCap size={20} />,
        text: 'Master on Coputer Science',
    },
    {
        icon: <HomeIcon size={20} />,
        text: '883, YI Palace, Park, AUS',
    },
];
                        ...
                        <div className="text-lg mt-12 xl:mt-8">
                            <TabsContent value='personal'>
                                <div className="text-center xl:text-left">
                                    <h3 className="h3 mb-4">Deliver quality for over 15 years</h3>
                                    ...
                                    <div className="flex flex-col gap-y-2">
                                        ...
                                        <div>English, Portuguse, Arabic, Spanish</div>
                                    </div>
                                </div>
                            </TabsContent>
